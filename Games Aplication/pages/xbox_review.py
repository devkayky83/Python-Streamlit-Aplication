...
try:
    df_xbox_reviews = pd.read_csv("../Games Aplication/datasets/XboxOne_GameSales.csv", encoding="utf-8")
except UnicodeDecodeError:
    df_xbox_reviews = pd.read_csv("../Games Aplication/datasets/XboxOne_GameSales.csv", encoding="latin-1")
...
df_review = df_xbox_reviews[df_xbox_reviews["Game"] == game]
